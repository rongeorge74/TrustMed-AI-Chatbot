...
K_HEAD = int(os.environ.get("K_HEAD", "8"))         
K_RECALL = int(os.environ.get("K_RECALL", "200"))    
BAND_MAX = int(os.environ.get("BAND_MAX", "120"))    

X0 = float(os.environ.get("X0", "0.65"))             
Y0 = float(os.environ.get("Y0", "0.45"))            
T_META0 = float(os.environ.get("T_META0", "0.35")) 

AGENT_MAX_ITERS = int(os.environ.get("AGENT_MAX_ITERS", "2"))  
